...
| Formato — notebook reproducible | [Notebook HTML](../codexway/notebooks/spot2_assessment.html) / [IPYNB](../codexway/notebooks/spot2_assessment.ipynb) | 7 capítulos; resumen dinámico; caso lead 6; código plegable | IPYNB ejecutado top-to-bottom (21/21 celdas sin error) y HTML autónomo validado en navegador | COMPLETO |
