...
| Formato — notebook reproducible | [Notebook HTML](../codexway/notebooks/spot2_assessment.html) / [IPYNB](../codexway/notebooks/spot2_assessment.ipynb) | 9 capítulos; 99 celdas totales; 35 celdas de código ejecutadas; lecturas, auditoría, EDA, ABT/feature policy, selección de Lead Quality, caso lead 6 y código plegable | IPYNB conserva ejecución top-to-bottom sin errores en sus 35 celdas de código; HTML autónomo sincronizado con las Partes 1–2 ampliadas | COMPLETO |
