...
Registro central: [EV-013 — Semantic profiles + Dynamic Need + Broker Service](../Evidencias/EV-013_matching_profiles_v4.md)

Interpretabilidad: [INTERPRETABILIDAD.md](INTERPRETABILIDAD.md)

Descubrimientos: [D038–D049](../conocimiento_agregado/DESCUBRIMIENTOS.md)

Trazabilidad autoritativa:
- Matching profiles v4 run 33287168139 — success.
- Governance CI 33287168148 — success.
